...
public class _PgTruetypid extends AbstractRoutine<Long> {
    ...
    private static final long serialVersionUID = -1587088152;
     ...
     */
    public static final Parameter<PgAttributeRecord> _1 = Internal.createParameter("_1", com.example.jooq.demo_jooq.introduction.db.pg_catalog.tables.PgAttribute.PG_ATTRIBUTE.getDataType(), false, true);

    /**
     * The parameter <code>information_schema._pg_truetypid._2</code>.
     */
    public static final Parameter<PgTypeRecord> _2 = Internal.createParameter("_2", com.example.jooq.demo_jooq.introduction.db.pg_catalog.tables.PgType.PG_TYPE.getDataType(), false, true);
