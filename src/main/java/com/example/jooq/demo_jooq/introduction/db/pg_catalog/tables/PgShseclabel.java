...
import com.example.jooq.demo_jooq.introduction.db.pg_catalog.tables.records.PgShseclabelRecord;
...
public class PgShseclabel extends TableImpl<PgShseclabelRecord> {
    ...
    private static final long serialVersionUID = 986409871;
     ...
     */
    public final TableField<PgShseclabelRecord, Long> OBJOID = createField(DSL.name("objoid"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_shseclabel.classoid</code>.
     */
    public final TableField<PgShseclabelRecord, Long> CLASSOID = createField(DSL.name("classoid"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_shseclabel.provider</code>.
     */
    public final TableField<PgShseclabelRecord, String> PROVIDER = createField(DSL.name("provider"), org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_shseclabel.label</code>.
     */
    public final TableField<PgShseclabelRecord, String> LABEL = createField(DSL.name("label"), org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");
