...
import com.example.jooq.demo_jooq.introduction.db.pg_catalog.tables.records.PgRulesRecord;
...
public class PgRules extends TableImpl<PgRulesRecord> {
    ...
    private static final long serialVersionUID = -212275762;
     ...
     */
    public final TableField<PgRulesRecord, String> SCHEMANAME = createField(DSL.name("schemaname"), org.jooq.impl.SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>pg_catalog.pg_rules.tablename</code>.
     */
    public final TableField<PgRulesRecord, String> TABLENAME = createField(DSL.name("tablename"), org.jooq.impl.SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>pg_catalog.pg_rules.rulename</code>.
     */
    public final TableField<PgRulesRecord, String> RULENAME = createField(DSL.name("rulename"), org.jooq.impl.SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>pg_catalog.pg_rules.definition</code>.
     */
    public final TableField<PgRulesRecord, String> DEFINITION = createField(DSL.name("definition"), org.jooq.impl.SQLDataType.CLOB, this, "");
