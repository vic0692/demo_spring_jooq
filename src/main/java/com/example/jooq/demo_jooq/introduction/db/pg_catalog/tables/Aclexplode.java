...
public class Aclexplode extends TableImpl<AclexplodeRecord> {
    ...
    private static final long serialVersionUID = 983504195;
     ...
     */
    public final TableField<AclexplodeRecord, Long> GRANTOR = createField(DSL.name("grantor"), org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.aclexplode.grantee</code>.
     */
    public final TableField<AclexplodeRecord, Long> GRANTEE = createField(DSL.name("grantee"), org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.aclexplode.privilege_type</code>.
     */
    public final TableField<AclexplodeRecord, String> PRIVILEGE_TYPE = createField(DSL.name("privilege_type"), org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>pg_catalog.aclexplode.is_grantable</code>.
     */
    public final TableField<AclexplodeRecord, Boolean> IS_GRANTABLE = createField(DSL.name("is_grantable"), org.jooq.impl.SQLDataType.BOOLEAN, this, "");
