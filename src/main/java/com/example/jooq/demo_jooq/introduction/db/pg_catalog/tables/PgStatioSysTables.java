...
import com.example.jooq.demo_jooq.introduction.db.pg_catalog.tables.records.PgStatioSysTablesRecord;
...
public class PgStatioSysTables extends TableImpl<PgStatioSysTablesRecord> {
    ...
    private static final long serialVersionUID = -1248123273;
     ...
     */
    public final TableField<PgStatioSysTablesRecord, Long> RELID = createField(DSL.name("relid"), org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_statio_sys_tables.schemaname</code>.
     */
    public final TableField<PgStatioSysTablesRecord, String> SCHEMANAME = createField(DSL.name("schemaname"), org.jooq.impl.SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>pg_catalog.pg_statio_sys_tables.relname</code>.
     */
    public final TableField<PgStatioSysTablesRecord, String> RELNAME = createField(DSL.name("relname"), org.jooq.impl.SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>pg_catalog.pg_statio_sys_tables.heap_blks_read</code>.
     */
    public final TableField<PgStatioSysTablesRecord, Long> HEAP_BLKS_READ = createField(DSL.name("heap_blks_read"), org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_statio_sys_tables.heap_blks_hit</code>.
     */
    public final TableField<PgStatioSysTablesRecord, Long> HEAP_BLKS_HIT = createField(DSL.name("heap_blks_hit"), org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_statio_sys_tables.idx_blks_read</code>.
     */
    public final TableField<PgStatioSysTablesRecord, Long> IDX_BLKS_READ = createField(DSL.name("idx_blks_read"), org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_statio_sys_tables.idx_blks_hit</code>.
     */
    public final TableField<PgStatioSysTablesRecord, Long> IDX_BLKS_HIT = createField(DSL.name("idx_blks_hit"), org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_statio_sys_tables.toast_blks_read</code>.
     */
    public final TableField<PgStatioSysTablesRecord, Long> TOAST_BLKS_READ = createField(DSL.name("toast_blks_read"), org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_statio_sys_tables.toast_blks_hit</code>.
     */
    public final TableField<PgStatioSysTablesRecord, Long> TOAST_BLKS_HIT = createField(DSL.name("toast_blks_hit"), org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_statio_sys_tables.tidx_blks_read</code>.
     */
    public final TableField<PgStatioSysTablesRecord, Long> TIDX_BLKS_READ = createField(DSL.name("tidx_blks_read"), org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_statio_sys_tables.tidx_blks_hit</code>.
     */
    public final TableField<PgStatioSysTablesRecord, Long> TIDX_BLKS_HIT = createField(DSL.name("tidx_blks_hit"), org.jooq.impl.SQLDataType.BIGINT, this, "");
