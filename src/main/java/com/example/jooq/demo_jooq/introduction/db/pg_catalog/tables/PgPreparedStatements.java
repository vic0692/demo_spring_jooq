...
import com.example.jooq.demo_jooq.introduction.db.pg_catalog.tables.records.PgPreparedStatementsRecord;
...
public class PgPreparedStatements extends TableImpl<PgPreparedStatementsRecord> {
    ...
    private static final long serialVersionUID = 1681043022;
     ...
     */
    public final TableField<PgPreparedStatementsRecord, String> NAME = createField(DSL.name("name"), org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>pg_catalog.pg_prepared_statements.statement</code>.
     */
    public final TableField<PgPreparedStatementsRecord, String> STATEMENT = createField(DSL.name("statement"), org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>pg_catalog.pg_prepared_statements.prepare_time</code>.
     */
    public final TableField<PgPreparedStatementsRecord, OffsetDateTime> PREPARE_TIME = createField(DSL.name("prepare_time"), org.jooq.impl.SQLDataType.TIMESTAMPWITHTIMEZONE, this, "");
     ...
     */
    public final TableField<PgPreparedStatementsRecord, Boolean> FROM_SQL = createField(DSL.name("from_sql"), org.jooq.impl.SQLDataType.BOOLEAN, this, "");
