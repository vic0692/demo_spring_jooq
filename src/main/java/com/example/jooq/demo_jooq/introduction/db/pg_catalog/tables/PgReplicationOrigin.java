...
import com.example.jooq.demo_jooq.introduction.db.pg_catalog.tables.records.PgReplicationOriginRecord;
...
public class PgReplicationOrigin extends TableImpl<PgReplicationOriginRecord> {
    ...
    private static final long serialVersionUID = 283346819;
     ...
     */
    public final TableField<PgReplicationOriginRecord, Long> ROIDENT = createField(DSL.name("roident"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_replication_origin.roname</code>.
     */
    public final TableField<PgReplicationOriginRecord, String> RONAME = createField(DSL.name("roname"), org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");
