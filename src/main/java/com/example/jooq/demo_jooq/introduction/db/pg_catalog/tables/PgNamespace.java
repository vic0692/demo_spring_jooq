...
import com.example.jooq.demo_jooq.introduction.db.pg_catalog.tables.records.PgNamespaceRecord;
...
public class PgNamespace extends TableImpl<PgNamespaceRecord> {
    ...
    private static final long serialVersionUID = -1060965235;
     ...
     */
    public final TableField<PgNamespaceRecord, String> NSPNAME = createField(DSL.name("nspname"), org.jooq.impl.SQLDataType.VARCHAR.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_namespace.nspowner</code>.
     */
    public final TableField<PgNamespaceRecord, Long> NSPOWNER = createField(DSL.name("nspowner"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_namespace.nspacl</code>.
     */
    public final TableField<PgNamespaceRecord, String[]> NSPACL = createField(DSL.name("nspacl"), org.jooq.impl.SQLDataType.VARCHAR.getArrayDataType(), this, "");
