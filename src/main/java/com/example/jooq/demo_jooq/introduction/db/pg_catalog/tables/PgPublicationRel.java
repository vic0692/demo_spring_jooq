...
import com.example.jooq.demo_jooq.introduction.db.pg_catalog.tables.records.PgPublicationRelRecord;
...
public class PgPublicationRel extends TableImpl<PgPublicationRelRecord> {
    ...
    private static final long serialVersionUID = -1740989747;
     ...
     */
    public final TableField<PgPublicationRelRecord, Long> PRPUBID = createField(DSL.name("prpubid"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_publication_rel.prrelid</code>.
     */
    public final TableField<PgPublicationRelRecord, Long> PRRELID = createField(DSL.name("prrelid"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
