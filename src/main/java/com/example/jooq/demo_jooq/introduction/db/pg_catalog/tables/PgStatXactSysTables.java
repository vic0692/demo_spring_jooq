...
import com.example.jooq.demo_jooq.introduction.db.pg_catalog.tables.records.PgStatXactSysTablesRecord;
...
public class PgStatXactSysTables extends TableImpl<PgStatXactSysTablesRecord> {
    ...
    private static final long serialVersionUID = 896847408;
     ...
     */
    public final TableField<PgStatXactSysTablesRecord, Long> RELID = createField(DSL.name("relid"), org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_xact_sys_tables.schemaname</code>.
     */
    public final TableField<PgStatXactSysTablesRecord, String> SCHEMANAME = createField(DSL.name("schemaname"), org.jooq.impl.SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_xact_sys_tables.relname</code>.
     */
    public final TableField<PgStatXactSysTablesRecord, String> RELNAME = createField(DSL.name("relname"), org.jooq.impl.SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_xact_sys_tables.seq_scan</code>.
     */
    public final TableField<PgStatXactSysTablesRecord, Long> SEQ_SCAN = createField(DSL.name("seq_scan"), org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_xact_sys_tables.seq_tup_read</code>.
     */
    public final TableField<PgStatXactSysTablesRecord, Long> SEQ_TUP_READ = createField(DSL.name("seq_tup_read"), org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_xact_sys_tables.idx_scan</code>.
     */
    public final TableField<PgStatXactSysTablesRecord, Long> IDX_SCAN = createField(DSL.name("idx_scan"), org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_xact_sys_tables.idx_tup_fetch</code>.
     */
    public final TableField<PgStatXactSysTablesRecord, Long> IDX_TUP_FETCH = createField(DSL.name("idx_tup_fetch"), org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_xact_sys_tables.n_tup_ins</code>.
     */
    public final TableField<PgStatXactSysTablesRecord, Long> N_TUP_INS = createField(DSL.name("n_tup_ins"), org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_xact_sys_tables.n_tup_upd</code>.
     */
    public final TableField<PgStatXactSysTablesRecord, Long> N_TUP_UPD = createField(DSL.name("n_tup_upd"), org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_xact_sys_tables.n_tup_del</code>.
     */
    public final TableField<PgStatXactSysTablesRecord, Long> N_TUP_DEL = createField(DSL.name("n_tup_del"), org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_xact_sys_tables.n_tup_hot_upd</code>.
     */
    public final TableField<PgStatXactSysTablesRecord, Long> N_TUP_HOT_UPD = createField(DSL.name("n_tup_hot_upd"), org.jooq.impl.SQLDataType.BIGINT, this, "");
