...
public class CursorToXml extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -1981245153;
     ...
     */
    public static final Parameter<Result<Record>> CURSOR = Internal.createParameter("cursor", org.jooq.impl.SQLDataType.RESULT, false, false);

    /**
     * The parameter <code>pg_catalog.cursor_to_xml.count</code>.
     */
    public static final Parameter<Integer> COUNT = Internal.createParameter("count", org.jooq.impl.SQLDataType.INTEGER, false, false);
