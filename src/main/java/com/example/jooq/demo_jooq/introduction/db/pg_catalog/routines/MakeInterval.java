...
public class MakeInterval extends AbstractRoutine<YearToSecond> {
    ...
    private static final long serialVersionUID = 1233519753;
     ...
     */
    public static final Parameter<Integer> YEARS = Internal.createParameter("years", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), true, false);

    /**
     * The parameter <code>pg_catalog.make_interval.months</code>.
     */
    public static final Parameter<Integer> MONTHS = Internal.createParameter("months", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), true, false);

    /**
     * The parameter <code>pg_catalog.make_interval.weeks</code>.
     */
    public static final Parameter<Integer> WEEKS = Internal.createParameter("weeks", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), true, false);

    /**
     * The parameter <code>pg_catalog.make_interval.days</code>.
     */
    public static final Parameter<Integer> DAYS = Internal.createParameter("days", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), true, false);

    /**
     * The parameter <code>pg_catalog.make_interval.hours</code>.
     */
    public static final Parameter<Integer> HOURS = Internal.createParameter("hours", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), true, false);

    /**
     * The parameter <code>pg_catalog.make_interval.mins</code>.
     */
    public static final Parameter<Integer> MINS = Internal.createParameter("mins", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), true, false);

    /**
     * The parameter <code>pg_catalog.make_interval.secs</code>.
     */
    public static final Parameter<Double> SECS = Internal.createParameter("secs", org.jooq.impl.SQLDataType.DOUBLE.defaultValue(org.jooq.impl.DSL.field("0.0", org.jooq.impl.SQLDataType.DOUBLE)), true, false);

    /**
     * Create a new routine call instance
     */
    public MakeInterval() {
        super("make_interval", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTERVAL);
