...
public class PgLsWaldir extends TableImpl<PgLsWaldirRecord> {
    ...
    private static final long serialVersionUID = -2014032236;
     ...
     */
    public final TableField<PgLsWaldirRecord, String> NAME = createField(DSL.name("name"), org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>pg_catalog.pg_ls_waldir.size</code>.
     */
    public final TableField<PgLsWaldirRecord, Long> SIZE = createField(DSL.name("size"), org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_ls_waldir.modification</code>.
     */
    public final TableField<PgLsWaldirRecord, OffsetDateTime> MODIFICATION = createField(DSL.name("modification"), org.jooq.impl.SQLDataType.TIMESTAMPWITHTIMEZONE, this, "");
