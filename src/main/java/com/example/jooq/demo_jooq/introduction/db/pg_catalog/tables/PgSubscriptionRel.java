...
import com.example.jooq.demo_jooq.introduction.db.pg_catalog.tables.records.PgSubscriptionRelRecord;
...
public class PgSubscriptionRel extends TableImpl<PgSubscriptionRelRecord> {
    ...
    private static final long serialVersionUID = 1529382164;
     ...
     */
    public final TableField<PgSubscriptionRelRecord, Long> SRSUBID = createField(DSL.name("srsubid"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_subscription_rel.srrelid</code>.
     */
    public final TableField<PgSubscriptionRelRecord, Long> SRRELID = createField(DSL.name("srrelid"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_subscription_rel.srsubstate</code>.
     */
    public final TableField<PgSubscriptionRelRecord, String> SRSUBSTATE = createField(DSL.name("srsubstate"), org.jooq.impl.SQLDataType.CHAR.nullable(false), this, "");

    /**
     * @deprecated Unknown data type. Please define an explicit {@link org.jooq.Binding} to specify how this type should be handled. Deprecation can be turned off using {@literal <deprecationOnUnknownTypes/>} in your code generator configuration.
     */
    @java.lang.Deprecated
    public final TableField<PgSubscriptionRelRecord, Object> SRSUBLSN = createField(DSL.name("srsublsn"), org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"pg_lsn\"").nullable(false), this, "");
