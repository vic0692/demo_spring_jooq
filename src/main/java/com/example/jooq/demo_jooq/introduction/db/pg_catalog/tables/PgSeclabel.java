...
import com.example.jooq.demo_jooq.introduction.db.pg_catalog.tables.records.PgSeclabelRecord;
...
public class PgSeclabel extends TableImpl<PgSeclabelRecord> {
    ...
    private static final long serialVersionUID = 1869379497;
     ...
     */
    public final TableField<PgSeclabelRecord, Long> OBJOID = createField(DSL.name("objoid"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_seclabel.classoid</code>.
     */
    public final TableField<PgSeclabelRecord, Long> CLASSOID = createField(DSL.name("classoid"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_seclabel.objsubid</code>.
     */
    public final TableField<PgSeclabelRecord, Integer> OBJSUBID = createField(DSL.name("objsubid"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_seclabel.provider</code>.
     */
    public final TableField<PgSeclabelRecord, String> PROVIDER = createField(DSL.name("provider"), org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_seclabel.label</code>.
     */
    public final TableField<PgSeclabelRecord, String> LABEL = createField(DSL.name("label"), org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");
