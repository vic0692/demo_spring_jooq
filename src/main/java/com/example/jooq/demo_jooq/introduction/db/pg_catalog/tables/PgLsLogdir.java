...
public class PgLsLogdir extends TableImpl<PgLsLogdirRecord> {
    ...
    private static final long serialVersionUID = 55869830;
     ...
     */
    public final TableField<PgLsLogdirRecord, String> NAME = createField(DSL.name("name"), org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>pg_catalog.pg_ls_logdir.size</code>.
     */
    public final TableField<PgLsLogdirRecord, Long> SIZE = createField(DSL.name("size"), org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_ls_logdir.modification</code>.
     */
    public final TableField<PgLsLogdirRecord, OffsetDateTime> MODIFICATION = createField(DSL.name("modification"), org.jooq.impl.SQLDataType.TIMESTAMPWITHTIMEZONE, this, "");
