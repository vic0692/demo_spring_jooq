...
import com.example.jooq.demo_jooq.introduction.db.pg_catalog.tables.records.PgAmopRecord;
...
public class PgAmop extends TableImpl<PgAmopRecord> {
    ...
    private static final long serialVersionUID = -422860016;
     ...
     */
    public final TableField<PgAmopRecord, Long> AMOPFAMILY = createField(DSL.name("amopfamily"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_amop.amoplefttype</code>.
     */
    public final TableField<PgAmopRecord, Long> AMOPLEFTTYPE = createField(DSL.name("amoplefttype"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_amop.amoprighttype</code>.
     */
    public final TableField<PgAmopRecord, Long> AMOPRIGHTTYPE = createField(DSL.name("amoprighttype"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_amop.amopstrategy</code>.
     */
    public final TableField<PgAmopRecord, Short> AMOPSTRATEGY = createField(DSL.name("amopstrategy"), org.jooq.impl.SQLDataType.SMALLINT.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_amop.amoppurpose</code>.
     */
    public final TableField<PgAmopRecord, String> AMOPPURPOSE = createField(DSL.name("amoppurpose"), org.jooq.impl.SQLDataType.CHAR.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_amop.amopopr</code>.
     */
    public final TableField<PgAmopRecord, Long> AMOPOPR = createField(DSL.name("amopopr"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_amop.amopmethod</code>.
     */
    public final TableField<PgAmopRecord, Long> AMOPMETHOD = createField(DSL.name("amopmethod"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_amop.amopsortfamily</code>.
     */
    public final TableField<PgAmopRecord, Long> AMOPSORTFAMILY = createField(DSL.name("amopsortfamily"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
