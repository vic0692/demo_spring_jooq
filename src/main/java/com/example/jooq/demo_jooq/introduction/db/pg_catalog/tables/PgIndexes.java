...
import com.example.jooq.demo_jooq.introduction.db.pg_catalog.tables.records.PgIndexesRecord;
...
public class PgIndexes extends TableImpl<PgIndexesRecord> {
    ...
    private static final long serialVersionUID = 87092229;
     ...
     */
    public final TableField<PgIndexesRecord, String> SCHEMANAME = createField(DSL.name("schemaname"), org.jooq.impl.SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>pg_catalog.pg_indexes.tablename</code>.
     */
    public final TableField<PgIndexesRecord, String> TABLENAME = createField(DSL.name("tablename"), org.jooq.impl.SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>pg_catalog.pg_indexes.indexname</code>.
     */
    public final TableField<PgIndexesRecord, String> INDEXNAME = createField(DSL.name("indexname"), org.jooq.impl.SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>pg_catalog.pg_indexes.tablespace</code>.
     */
    public final TableField<PgIndexesRecord, String> TABLESPACE = createField(DSL.name("tablespace"), org.jooq.impl.SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>pg_catalog.pg_indexes.indexdef</code>.
     */
    public final TableField<PgIndexesRecord, String> INDEXDEF = createField(DSL.name("indexdef"), org.jooq.impl.SQLDataType.CLOB, this, "");
