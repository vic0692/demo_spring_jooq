...
import com.example.jooq.demo_jooq.introduction.db.pg_catalog.tables.records.PgPublicationTablesRecord;
...
public class PgPublicationTables extends TableImpl<PgPublicationTablesRecord> {
    ...
    private static final long serialVersionUID = 399897491;
     ...
     */
    public final TableField<PgPublicationTablesRecord, String> PUBNAME = createField(DSL.name("pubname"), org.jooq.impl.SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>pg_catalog.pg_publication_tables.schemaname</code>.
     */
    public final TableField<PgPublicationTablesRecord, String> SCHEMANAME = createField(DSL.name("schemaname"), org.jooq.impl.SQLDataType.VARCHAR, this, "");

    /**
     * The column <code>pg_catalog.pg_publication_tables.tablename</code>.
     */
    public final TableField<PgPublicationTablesRecord, String> TABLENAME = createField(DSL.name("tablename"), org.jooq.impl.SQLDataType.VARCHAR, this, "");
