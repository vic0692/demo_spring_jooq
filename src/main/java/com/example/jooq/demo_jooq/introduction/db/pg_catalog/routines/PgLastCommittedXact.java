...
public class PgLastCommittedXact extends AbstractRoutine<java.lang.Void> {
    ...
    private static final long serialVersionUID = -1505972479;

    /**
     * The parameter <code>pg_catalog.pg_last_committed_xact.xid</code>.
     */
    public static final Parameter<Long> XID = Internal.createParameter("xid", org.jooq.impl.SQLDataType.BIGINT, false, false);

    /**
     * The parameter <code>pg_catalog.pg_last_committed_xact.timestamp</code>.
     */
    public static final Parameter<OffsetDateTime> TIMESTAMP = Internal.createParameter("timestamp", org.jooq.impl.SQLDataType.TIMESTAMPWITHTIMEZONE, false, false);
