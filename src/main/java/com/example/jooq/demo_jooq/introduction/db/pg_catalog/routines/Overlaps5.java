...
public class Overlaps5 extends AbstractRoutine<Boolean> {
    ...
    private static final long serialVersionUID = -1949572422;
     ...
     */
    public static final Parameter<OffsetDateTime> _3 = Internal.createParameter("_3", org.jooq.impl.SQLDataType.TIMESTAMPWITHTIMEZONE, false, true);

    /**
     * The parameter <code>pg_catalog.overlaps._4</code>.
     */
    public static final Parameter<OffsetDateTime> _4 = Internal.createParameter("_4", org.jooq.impl.SQLDataType.TIMESTAMPWITHTIMEZONE, false, true);
