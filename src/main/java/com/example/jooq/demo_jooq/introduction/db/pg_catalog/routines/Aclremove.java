...
public class Aclremove extends AbstractRoutine<String[]> {
    ...
    private static final long serialVersionUID = 1112776908;
     ...
     */
    public static final Parameter<String[]> _1 = Internal.createParameter("_1", org.jooq.impl.SQLDataType.VARCHAR.getArrayDataType(), false, true);
