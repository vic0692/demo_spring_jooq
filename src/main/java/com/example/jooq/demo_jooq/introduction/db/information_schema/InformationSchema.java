...
import com.example.jooq.demo_jooq.introduction.db.information_schema.tables.Tables;
...
public class InformationSchema extends SchemaImpl {
    ...
    private static final long serialVersionUID = 1687691912;
     ...
     */
    public final _PgExpandarray _PG_EXPANDARRAY = com.example.jooq.demo_jooq.introduction.db.information_schema.tables._PgExpandarray._PG_EXPANDARRAY;
     ...
     */
    public final _PgForeignDataWrappers _PG_FOREIGN_DATA_WRAPPERS = com.example.jooq.demo_jooq.introduction.db.information_schema.tables._PgForeignDataWrappers._PG_FOREIGN_DATA_WRAPPERS;

    /**
     * The table <code>information_schema._pg_foreign_servers</code>.
     */
    public final _PgForeignServers _PG_FOREIGN_SERVERS = com.example.jooq.demo_jooq.introduction.db.information_schema.tables._PgForeignServers._PG_FOREIGN_SERVERS;

    /**
     * The table <code>information_schema._pg_foreign_table_columns</code>.
     */
    public final _PgForeignTableColumns _PG_FOREIGN_TABLE_COLUMNS = com.example.jooq.demo_jooq.introduction.db.information_schema.tables._PgForeignTableColumns._PG_FOREIGN_TABLE_COLUMNS;

    /**
     * The table <code>information_schema._pg_foreign_tables</code>.
     */
    public final _PgForeignTables _PG_FOREIGN_TABLES = com.example.jooq.demo_jooq.introduction.db.information_schema.tables._PgForeignTables._PG_FOREIGN_TABLES;

    /**
     * The table <code>information_schema._pg_user_mappings</code>.
     */
    public final _PgUserMappings _PG_USER_MAPPINGS = com.example.jooq.demo_jooq.introduction.db.information_schema.tables._PgUserMappings._PG_USER_MAPPINGS;

    /**
     * The table <code>information_schema.administrable_role_authorizations</code>.
     */
    public final AdministrableRoleAuthorizations ADMINISTRABLE_ROLE_AUTHORIZATIONS = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.AdministrableRoleAuthorizations.ADMINISTRABLE_ROLE_AUTHORIZATIONS;

    /**
     * The table <code>information_schema.applicable_roles</code>.
     */
    public final ApplicableRoles APPLICABLE_ROLES = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.ApplicableRoles.APPLICABLE_ROLES;

    /**
     * The table <code>information_schema.attributes</code>.
     */
    public final Attributes ATTRIBUTES = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.Attributes.ATTRIBUTES;

    /**
     * The table <code>information_schema.character_sets</code>.
     */
    public final CharacterSets CHARACTER_SETS = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.CharacterSets.CHARACTER_SETS;

    /**
     * The table <code>information_schema.check_constraint_routine_usage</code>.
     */
    public final CheckConstraintRoutineUsage CHECK_CONSTRAINT_ROUTINE_USAGE = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.CheckConstraintRoutineUsage.CHECK_CONSTRAINT_ROUTINE_USAGE;

    /**
     * The table <code>information_schema.check_constraints</code>.
     */
    public final CheckConstraints CHECK_CONSTRAINTS = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.CheckConstraints.CHECK_CONSTRAINTS;

    /**
     * The table <code>information_schema.collation_character_set_applicability</code>.
     */
    public final CollationCharacterSetApplicability COLLATION_CHARACTER_SET_APPLICABILITY = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.CollationCharacterSetApplicability.COLLATION_CHARACTER_SET_APPLICABILITY;

    /**
     * The table <code>information_schema.collations</code>.
     */
    public final Collations COLLATIONS = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.Collations.COLLATIONS;

    /**
     * The table <code>information_schema.column_domain_usage</code>.
     */
    public final ColumnDomainUsage COLUMN_DOMAIN_USAGE = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.ColumnDomainUsage.COLUMN_DOMAIN_USAGE;

    /**
     * The table <code>information_schema.column_options</code>.
     */
    public final ColumnOptions COLUMN_OPTIONS = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.ColumnOptions.COLUMN_OPTIONS;

    /**
     * The table <code>information_schema.column_privileges</code>.
     */
    public final ColumnPrivileges COLUMN_PRIVILEGES = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.ColumnPrivileges.COLUMN_PRIVILEGES;

    /**
     * The table <code>information_schema.column_udt_usage</code>.
     */
    public final ColumnUdtUsage COLUMN_UDT_USAGE = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.ColumnUdtUsage.COLUMN_UDT_USAGE;

    /**
     * The table <code>information_schema.columns</code>.
     */
    public final Columns COLUMNS = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.Columns.COLUMNS;

    /**
     * The table <code>information_schema.constraint_column_usage</code>.
     */
    public final ConstraintColumnUsage CONSTRAINT_COLUMN_USAGE = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.ConstraintColumnUsage.CONSTRAINT_COLUMN_USAGE;

    /**
     * The table <code>information_schema.constraint_table_usage</code>.
     */
    public final ConstraintTableUsage CONSTRAINT_TABLE_USAGE = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.ConstraintTableUsage.CONSTRAINT_TABLE_USAGE;

    /**
     * The table <code>information_schema.data_type_privileges</code>.
     */
    public final DataTypePrivileges DATA_TYPE_PRIVILEGES = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.DataTypePrivileges.DATA_TYPE_PRIVILEGES;

    /**
     * The table <code>information_schema.domain_constraints</code>.
     */
    public final DomainConstraints DOMAIN_CONSTRAINTS = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.DomainConstraints.DOMAIN_CONSTRAINTS;

    /**
     * The table <code>information_schema.domain_udt_usage</code>.
     */
    public final DomainUdtUsage DOMAIN_UDT_USAGE = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.DomainUdtUsage.DOMAIN_UDT_USAGE;

    /**
     * The table <code>information_schema.domains</code>.
     */
    public final Domains DOMAINS = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.Domains.DOMAINS;

    /**
     * The table <code>information_schema.element_types</code>.
     */
    public final ElementTypes ELEMENT_TYPES = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.ElementTypes.ELEMENT_TYPES;

    /**
     * The table <code>information_schema.enabled_roles</code>.
     */
    public final EnabledRoles ENABLED_ROLES = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.EnabledRoles.ENABLED_ROLES;

    /**
     * The table <code>information_schema.foreign_data_wrapper_options</code>.
     */
    public final ForeignDataWrapperOptions FOREIGN_DATA_WRAPPER_OPTIONS = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.ForeignDataWrapperOptions.FOREIGN_DATA_WRAPPER_OPTIONS;

    /**
     * The table <code>information_schema.foreign_data_wrappers</code>.
     */
    public final ForeignDataWrappers FOREIGN_DATA_WRAPPERS = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.ForeignDataWrappers.FOREIGN_DATA_WRAPPERS;

    /**
     * The table <code>information_schema.foreign_server_options</code>.
     */
    public final ForeignServerOptions FOREIGN_SERVER_OPTIONS = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.ForeignServerOptions.FOREIGN_SERVER_OPTIONS;

    /**
     * The table <code>information_schema.foreign_servers</code>.
     */
    public final ForeignServers FOREIGN_SERVERS = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.ForeignServers.FOREIGN_SERVERS;

    /**
     * The table <code>information_schema.foreign_table_options</code>.
     */
    public final ForeignTableOptions FOREIGN_TABLE_OPTIONS = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.ForeignTableOptions.FOREIGN_TABLE_OPTIONS;

    /**
     * The table <code>information_schema.foreign_tables</code>.
     */
    public final ForeignTables FOREIGN_TABLES = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.ForeignTables.FOREIGN_TABLES;

    /**
     * The table <code>information_schema.information_schema_catalog_name</code>.
     */
    public final InformationSchemaCatalogName INFORMATION_SCHEMA_CATALOG_NAME = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.InformationSchemaCatalogName.INFORMATION_SCHEMA_CATALOG_NAME;

    /**
     * The table <code>information_schema.key_column_usage</code>.
     */
    public final KeyColumnUsage KEY_COLUMN_USAGE = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.KeyColumnUsage.KEY_COLUMN_USAGE;

    /**
     * The table <code>information_schema.parameters</code>.
     */
    public final Parameters PARAMETERS = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.Parameters.PARAMETERS;

    /**
     * The table <code>information_schema.referential_constraints</code>.
     */
    public final ReferentialConstraints REFERENTIAL_CONSTRAINTS = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.ReferentialConstraints.REFERENTIAL_CONSTRAINTS;

    /**
     * The table <code>information_schema.role_column_grants</code>.
     */
    public final RoleColumnGrants ROLE_COLUMN_GRANTS = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.RoleColumnGrants.ROLE_COLUMN_GRANTS;

    /**
     * The table <code>information_schema.role_routine_grants</code>.
     */
    public final RoleRoutineGrants ROLE_ROUTINE_GRANTS = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.RoleRoutineGrants.ROLE_ROUTINE_GRANTS;

    /**
     * The table <code>information_schema.role_table_grants</code>.
     */
    public final RoleTableGrants ROLE_TABLE_GRANTS = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.RoleTableGrants.ROLE_TABLE_GRANTS;

    /**
     * The table <code>information_schema.role_udt_grants</code>.
     */
    public final RoleUdtGrants ROLE_UDT_GRANTS = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.RoleUdtGrants.ROLE_UDT_GRANTS;

    /**
     * The table <code>information_schema.role_usage_grants</code>.
     */
    public final RoleUsageGrants ROLE_USAGE_GRANTS = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.RoleUsageGrants.ROLE_USAGE_GRANTS;

    /**
     * The table <code>information_schema.routine_privileges</code>.
     */
    public final RoutinePrivileges ROUTINE_PRIVILEGES = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.RoutinePrivileges.ROUTINE_PRIVILEGES;

    /**
     * The table <code>information_schema.routines</code>.
     */
    public final Routines ROUTINES = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.Routines.ROUTINES;

    /**
     * The table <code>information_schema.schemata</code>.
     */
    public final Schemata SCHEMATA = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.Schemata.SCHEMATA;

    /**
     * The table <code>information_schema.sequences</code>.
     */
    public final Sequences SEQUENCES = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.Sequences.SEQUENCES;

    /**
     * The table <code>information_schema.sql_features</code>.
     */
    public final SqlFeatures SQL_FEATURES = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.SqlFeatures.SQL_FEATURES;

    /**
     * The table <code>information_schema.sql_implementation_info</code>.
     */
    public final SqlImplementationInfo SQL_IMPLEMENTATION_INFO = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.SqlImplementationInfo.SQL_IMPLEMENTATION_INFO;

    /**
     * The table <code>information_schema.sql_languages</code>.
     */
    public final SqlLanguages SQL_LANGUAGES = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.SqlLanguages.SQL_LANGUAGES;

    /**
     * The table <code>information_schema.sql_packages</code>.
     */
    public final SqlPackages SQL_PACKAGES = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.SqlPackages.SQL_PACKAGES;

    /**
     * The table <code>information_schema.sql_parts</code>.
     */
    public final SqlParts SQL_PARTS = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.SqlParts.SQL_PARTS;

    /**
     * The table <code>information_schema.sql_sizing</code>.
     */
    public final SqlSizing SQL_SIZING = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.SqlSizing.SQL_SIZING;

    /**
     * The table <code>information_schema.sql_sizing_profiles</code>.
     */
    public final SqlSizingProfiles SQL_SIZING_PROFILES = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.SqlSizingProfiles.SQL_SIZING_PROFILES;

    /**
     * The table <code>information_schema.table_constraints</code>.
     */
    public final TableConstraints TABLE_CONSTRAINTS = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.TableConstraints.TABLE_CONSTRAINTS;

    /**
     * The table <code>information_schema.table_privileges</code>.
     */
    public final TablePrivileges TABLE_PRIVILEGES = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.TablePrivileges.TABLE_PRIVILEGES;

    /**
     * The table <code>information_schema.tables</code>.
     */
    public final Tables TABLES = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.Tables.TABLES;

    /**
     * The table <code>information_schema.transforms</code>.
     */
    public final Transforms TRANSFORMS = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.Transforms.TRANSFORMS;

    /**
     * The table <code>information_schema.triggered_update_columns</code>.
     */
    public final TriggeredUpdateColumns TRIGGERED_UPDATE_COLUMNS = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.TriggeredUpdateColumns.TRIGGERED_UPDATE_COLUMNS;

    /**
     * The table <code>information_schema.triggers</code>.
     */
    public final Triggers TRIGGERS = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.Triggers.TRIGGERS;

    /**
     * The table <code>information_schema.udt_privileges</code>.
     */
    public final UdtPrivileges UDT_PRIVILEGES = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.UdtPrivileges.UDT_PRIVILEGES;

    /**
     * The table <code>information_schema.usage_privileges</code>.
     */
    public final UsagePrivileges USAGE_PRIVILEGES = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.UsagePrivileges.USAGE_PRIVILEGES;

    /**
     * The table <code>information_schema.user_defined_types</code>.
     */
    public final UserDefinedTypes USER_DEFINED_TYPES = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.UserDefinedTypes.USER_DEFINED_TYPES;

    /**
     * The table <code>information_schema.user_mapping_options</code>.
     */
    public final UserMappingOptions USER_MAPPING_OPTIONS = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.UserMappingOptions.USER_MAPPING_OPTIONS;

    /**
     * The table <code>information_schema.user_mappings</code>.
     */
    public final UserMappings USER_MAPPINGS = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.UserMappings.USER_MAPPINGS;

    /**
     * The table <code>information_schema.view_column_usage</code>.
     */
    public final ViewColumnUsage VIEW_COLUMN_USAGE = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.ViewColumnUsage.VIEW_COLUMN_USAGE;

    /**
     * The table <code>information_schema.view_routine_usage</code>.
     */
    public final ViewRoutineUsage VIEW_ROUTINE_USAGE = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.ViewRoutineUsage.VIEW_ROUTINE_USAGE;

    /**
     * The table <code>information_schema.view_table_usage</code>.
     */
    public final ViewTableUsage VIEW_TABLE_USAGE = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.ViewTableUsage.VIEW_TABLE_USAGE;

    /**
     * The table <code>information_schema.views</code>.
     */
    public final Views VIEWS = com.example.jooq.demo_jooq.introduction.db.information_schema.tables.Views.VIEWS;
