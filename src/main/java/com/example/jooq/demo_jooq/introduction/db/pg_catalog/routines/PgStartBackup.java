...
public class PgStartBackup extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 494898357;
     ...
     */
    public static final Parameter<String> LABEL = Internal.createParameter("label", org.jooq.impl.SQLDataType.CLOB, false, false);

    /**
     * The parameter <code>pg_catalog.pg_start_backup.fast</code>.
     */
    public static final Parameter<Boolean> FAST = Internal.createParameter("fast", org.jooq.impl.SQLDataType.BOOLEAN.defaultValue(org.jooq.impl.DSL.field("false", org.jooq.impl.SQLDataType.BOOLEAN)), true, false);

    /**
     * The parameter <code>pg_catalog.pg_start_backup.exclusive</code>.
     */
    public static final Parameter<Boolean> EXCLUSIVE = Internal.createParameter("exclusive", org.jooq.impl.SQLDataType.BOOLEAN.defaultValue(org.jooq.impl.DSL.field("true", org.jooq.impl.SQLDataType.BOOLEAN)), true, false);
