...
import com.example.jooq.demo_jooq.introduction.db.pg_catalog.tables.records.PgLargeobjectMetadataRecord;
...
public class PgLargeobjectMetadata extends TableImpl<PgLargeobjectMetadataRecord> {
    ...
    private static final long serialVersionUID = 396957437;
     ...
     */
    public final TableField<PgLargeobjectMetadataRecord, Long> LOMOWNER = createField(DSL.name("lomowner"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_largeobject_metadata.lomacl</code>.
     */
    public final TableField<PgLargeobjectMetadataRecord, String[]> LOMACL = createField(DSL.name("lomacl"), org.jooq.impl.SQLDataType.VARCHAR.getArrayDataType(), this, "");
