...
public class PgLogicalSlotGetBinaryChanges extends TableImpl<PgLogicalSlotGetBinaryChangesRecord> {
    ...
    private static final long serialVersionUID = -700156280;
     ...
     */
    public final TableField<PgLogicalSlotGetBinaryChangesRecord, Long> XID = createField(DSL.name("xid"), org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_logical_slot_get_binary_changes.data</code>.
     */
    public final TableField<PgLogicalSlotGetBinaryChangesRecord, byte[]> DATA = createField(DSL.name("data"), org.jooq.impl.SQLDataType.BLOB, this, "");
