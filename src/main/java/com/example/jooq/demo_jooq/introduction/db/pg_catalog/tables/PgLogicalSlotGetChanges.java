...
public class PgLogicalSlotGetChanges extends TableImpl<PgLogicalSlotGetChangesRecord> {
    ...
    private static final long serialVersionUID = 767514332;
     ...
     */
    public final TableField<PgLogicalSlotGetChangesRecord, Long> XID = createField(DSL.name("xid"), org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_logical_slot_get_changes.data</code>.
     */
    public final TableField<PgLogicalSlotGetChangesRecord, String> DATA = createField(DSL.name("data"), org.jooq.impl.SQLDataType.CLOB, this, "");
