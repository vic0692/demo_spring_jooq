...
import com.example.jooq.demo_jooq.introduction.db.pg_catalog.tables.records.PgForeignTableRecord;
...
public class PgForeignTable extends TableImpl<PgForeignTableRecord> {
    ...
    private static final long serialVersionUID = -2063370171;
     ...
     */
    public final TableField<PgForeignTableRecord, Long> FTRELID = createField(DSL.name("ftrelid"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_foreign_table.ftserver</code>.
     */
    public final TableField<PgForeignTableRecord, Long> FTSERVER = createField(DSL.name("ftserver"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_foreign_table.ftoptions</code>.
     */
    public final TableField<PgForeignTableRecord, String[]> FTOPTIONS = createField(DSL.name("ftoptions"), org.jooq.impl.SQLDataType.CLOB.getArrayDataType(), this, "");
