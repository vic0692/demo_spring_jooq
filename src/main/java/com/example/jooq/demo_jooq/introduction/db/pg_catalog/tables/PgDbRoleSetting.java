...
import com.example.jooq.demo_jooq.introduction.db.pg_catalog.tables.records.PgDbRoleSettingRecord;
...
public class PgDbRoleSetting extends TableImpl<PgDbRoleSettingRecord> {
    ...
    private static final long serialVersionUID = 1654167086;
     ...
     */
    public final TableField<PgDbRoleSettingRecord, Long> SETDATABASE = createField(DSL.name("setdatabase"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_db_role_setting.setrole</code>.
     */
    public final TableField<PgDbRoleSettingRecord, Long> SETROLE = createField(DSL.name("setrole"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_db_role_setting.setconfig</code>.
     */
    public final TableField<PgDbRoleSettingRecord, String[]> SETCONFIG = createField(DSL.name("setconfig"), org.jooq.impl.SQLDataType.CLOB.getArrayDataType(), this, "");
