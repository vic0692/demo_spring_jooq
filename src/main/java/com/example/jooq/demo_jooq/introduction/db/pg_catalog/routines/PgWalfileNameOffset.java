...
public class PgWalfileNameOffset extends AbstractRoutine<java.lang.Void> {
    ...
    private static final long serialVersionUID = 1878272861;
     ...
     */
    public static final Parameter<String> FILE_NAME = Internal.createParameter("file_name", org.jooq.impl.SQLDataType.CLOB, false, false);

    /**
     * The parameter <code>pg_catalog.pg_walfile_name_offset.file_offset</code>.
     */
    public static final Parameter<Integer> FILE_OFFSET = Internal.createParameter("file_offset", org.jooq.impl.SQLDataType.INTEGER, false, false);
