...
public class PgStatGetArchiver extends AbstractRoutine<java.lang.Void> {
    ...
    private static final long serialVersionUID = -1226085415;

    /**
     * The parameter <code>pg_catalog.pg_stat_get_archiver.archived_count</code>.
     */
    public static final Parameter<Long> ARCHIVED_COUNT = Internal.createParameter("archived_count", org.jooq.impl.SQLDataType.BIGINT, false, false);

    /**
     * The parameter <code>pg_catalog.pg_stat_get_archiver.last_archived_wal</code>.
     */
    public static final Parameter<String> LAST_ARCHIVED_WAL = Internal.createParameter("last_archived_wal", org.jooq.impl.SQLDataType.CLOB, false, false);

    /**
     * The parameter <code>pg_catalog.pg_stat_get_archiver.last_archived_time</code>.
     */
    public static final Parameter<OffsetDateTime> LAST_ARCHIVED_TIME = Internal.createParameter("last_archived_time", org.jooq.impl.SQLDataType.TIMESTAMPWITHTIMEZONE, false, false);

    /**
     * The parameter <code>pg_catalog.pg_stat_get_archiver.failed_count</code>.
     */
    public static final Parameter<Long> FAILED_COUNT = Internal.createParameter("failed_count", org.jooq.impl.SQLDataType.BIGINT, false, false);

    /**
     * The parameter <code>pg_catalog.pg_stat_get_archiver.last_failed_wal</code>.
     */
    public static final Parameter<String> LAST_FAILED_WAL = Internal.createParameter("last_failed_wal", org.jooq.impl.SQLDataType.CLOB, false, false);

    /**
     * The parameter <code>pg_catalog.pg_stat_get_archiver.last_failed_time</code>.
     */
    public static final Parameter<OffsetDateTime> LAST_FAILED_TIME = Internal.createParameter("last_failed_time", org.jooq.impl.SQLDataType.TIMESTAMPWITHTIMEZONE, false, false);

    /**
     * The parameter <code>pg_catalog.pg_stat_get_archiver.stats_reset</code>.
     */
    public static final Parameter<OffsetDateTime> STATS_RESET = Internal.createParameter("stats_reset", org.jooq.impl.SQLDataType.TIMESTAMPWITHTIMEZONE, false, false);
