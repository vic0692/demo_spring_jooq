...
public class PgIdentifyObjectAsAddress extends AbstractRoutine<java.lang.Void> {
    ...
    private static final long serialVersionUID = -1886525947;
     ...
     */
    public static final Parameter<String[]> OBJECT_NAMES = Internal.createParameter("object_names", org.jooq.impl.SQLDataType.CLOB.getArrayDataType(), false, false);

    /**
     * The parameter <code>pg_catalog.pg_identify_object_as_address.object_args</code>.
     */
    public static final Parameter<String[]> OBJECT_ARGS = Internal.createParameter("object_args", org.jooq.impl.SQLDataType.CLOB.getArrayDataType(), false, false);
