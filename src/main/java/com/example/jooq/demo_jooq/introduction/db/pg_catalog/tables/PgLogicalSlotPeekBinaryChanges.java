...
public class PgLogicalSlotPeekBinaryChanges extends TableImpl<PgLogicalSlotPeekBinaryChangesRecord> {
    ...
    private static final long serialVersionUID = -109492416;
     ...
     */
    public final TableField<PgLogicalSlotPeekBinaryChangesRecord, Long> XID = createField(DSL.name("xid"), org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_logical_slot_peek_binary_changes.data</code>.
     */
    public final TableField<PgLogicalSlotPeekBinaryChangesRecord, byte[]> DATA = createField(DSL.name("data"), org.jooq.impl.SQLDataType.BLOB, this, "");
