...
import com.example.jooq.demo_jooq.introduction.db.pg_catalog.tables.records.PgCollationRecord;
...
public class PgCollation extends TableImpl<PgCollationRecord> {
    ...
    private static final long serialVersionUID = 338118320;
     ...
     */
    public final TableField<PgCollationRecord, String> COLLNAME = createField(DSL.name("collname"), org.jooq.impl.SQLDataType.VARCHAR.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_collation.collnamespace</code>.
     */
    public final TableField<PgCollationRecord, Long> COLLNAMESPACE = createField(DSL.name("collnamespace"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_collation.collowner</code>.
     */
    public final TableField<PgCollationRecord, Long> COLLOWNER = createField(DSL.name("collowner"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_collation.collprovider</code>.
     */
    public final TableField<PgCollationRecord, String> COLLPROVIDER = createField(DSL.name("collprovider"), org.jooq.impl.SQLDataType.CHAR.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_collation.collencoding</code>.
     */
    public final TableField<PgCollationRecord, Integer> COLLENCODING = createField(DSL.name("collencoding"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_collation.collcollate</code>.
     */
    public final TableField<PgCollationRecord, String> COLLCOLLATE = createField(DSL.name("collcollate"), org.jooq.impl.SQLDataType.VARCHAR.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_collation.collctype</code>.
     */
    public final TableField<PgCollationRecord, String> COLLCTYPE = createField(DSL.name("collctype"), org.jooq.impl.SQLDataType.VARCHAR.nullable(false), this, "");

    /**
     * The column <code>pg_catalog.pg_collation.collversion</code>.
     */
    public final TableField<PgCollationRecord, String> COLLVERSION = createField(DSL.name("collversion"), org.jooq.impl.SQLDataType.CLOB, this, "");
