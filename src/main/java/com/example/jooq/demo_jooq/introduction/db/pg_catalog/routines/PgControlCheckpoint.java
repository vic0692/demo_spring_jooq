...
public class PgControlCheckpoint extends AbstractRoutine<java.lang.Void> {
    ...
    private static final long serialVersionUID = -889577772;
     ...
     */
    @java.lang.Deprecated
    public static final Parameter<Object> PRIOR_LSN = Internal.createParameter("prior_lsn", org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"pg_lsn\""), false, false);
     ...
     */
    public static final Parameter<String> REDO_WAL_FILE = Internal.createParameter("redo_wal_file", org.jooq.impl.SQLDataType.CLOB, false, false);

    /**
     * The parameter <code>pg_catalog.pg_control_checkpoint.timeline_id</code>.
     */
    public static final Parameter<Integer> TIMELINE_ID = Internal.createParameter("timeline_id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>pg_catalog.pg_control_checkpoint.prev_timeline_id</code>.
     */
    public static final Parameter<Integer> PREV_TIMELINE_ID = Internal.createParameter("prev_timeline_id", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>pg_catalog.pg_control_checkpoint.full_page_writes</code>.
     */
    public static final Parameter<Boolean> FULL_PAGE_WRITES = Internal.createParameter("full_page_writes", org.jooq.impl.SQLDataType.BOOLEAN, false, false);

    /**
     * The parameter <code>pg_catalog.pg_control_checkpoint.next_xid</code>.
     */
    public static final Parameter<String> NEXT_XID = Internal.createParameter("next_xid", org.jooq.impl.SQLDataType.CLOB, false, false);

    /**
     * The parameter <code>pg_catalog.pg_control_checkpoint.next_oid</code>.
     */
    public static final Parameter<Long> NEXT_OID = Internal.createParameter("next_oid", org.jooq.impl.SQLDataType.BIGINT, false, false);

    /**
     * The parameter <code>pg_catalog.pg_control_checkpoint.next_multixact_id</code>.
     */
    public static final Parameter<Long> NEXT_MULTIXACT_ID = Internal.createParameter("next_multixact_id", org.jooq.impl.SQLDataType.BIGINT, false, false);

    /**
     * The parameter <code>pg_catalog.pg_control_checkpoint.next_multi_offset</code>.
     */
    public static final Parameter<Long> NEXT_MULTI_OFFSET = Internal.createParameter("next_multi_offset", org.jooq.impl.SQLDataType.BIGINT, false, false);

    /**
     * The parameter <code>pg_catalog.pg_control_checkpoint.oldest_xid</code>.
     */
    public static final Parameter<Long> OLDEST_XID = Internal.createParameter("oldest_xid", org.jooq.impl.SQLDataType.BIGINT, false, false);

    /**
     * The parameter <code>pg_catalog.pg_control_checkpoint.oldest_xid_dbid</code>.
     */
    public static final Parameter<Long> OLDEST_XID_DBID = Internal.createParameter("oldest_xid_dbid", org.jooq.impl.SQLDataType.BIGINT, false, false);

    /**
     * The parameter <code>pg_catalog.pg_control_checkpoint.oldest_active_xid</code>.
     */
    public static final Parameter<Long> OLDEST_ACTIVE_XID = Internal.createParameter("oldest_active_xid", org.jooq.impl.SQLDataType.BIGINT, false, false);

    /**
     * The parameter <code>pg_catalog.pg_control_checkpoint.oldest_multi_xid</code>.
     */
    public static final Parameter<Long> OLDEST_MULTI_XID = Internal.createParameter("oldest_multi_xid", org.jooq.impl.SQLDataType.BIGINT, false, false);

    /**
     * The parameter <code>pg_catalog.pg_control_checkpoint.oldest_multi_dbid</code>.
     */
    public static final Parameter<Long> OLDEST_MULTI_DBID = Internal.createParameter("oldest_multi_dbid", org.jooq.impl.SQLDataType.BIGINT, false, false);

    /**
     * The parameter <code>pg_catalog.pg_control_checkpoint.oldest_commit_ts_xid</code>.
     */
    public static final Parameter<Long> OLDEST_COMMIT_TS_XID = Internal.createParameter("oldest_commit_ts_xid", org.jooq.impl.SQLDataType.BIGINT, false, false);

    /**
     * The parameter <code>pg_catalog.pg_control_checkpoint.newest_commit_ts_xid</code>.
     */
    public static final Parameter<Long> NEWEST_COMMIT_TS_XID = Internal.createParameter("newest_commit_ts_xid", org.jooq.impl.SQLDataType.BIGINT, false, false);

    /**
     * The parameter <code>pg_catalog.pg_control_checkpoint.checkpoint_time</code>.
     */
    public static final Parameter<OffsetDateTime> CHECKPOINT_TIME = Internal.createParameter("checkpoint_time", org.jooq.impl.SQLDataType.TIMESTAMPWITHTIMEZONE, false, false);
