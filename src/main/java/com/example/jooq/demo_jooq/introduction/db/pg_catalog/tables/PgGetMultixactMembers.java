...
public class PgGetMultixactMembers extends TableImpl<PgGetMultixactMembersRecord> {
    ...
    private static final long serialVersionUID = -1240422361;
     ...
     */
    public final TableField<PgGetMultixactMembersRecord, Long> XID = createField(DSL.name("xid"), org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_get_multixact_members.mode</code>.
     */
    public final TableField<PgGetMultixactMembersRecord, String> MODE = createField(DSL.name("mode"), org.jooq.impl.SQLDataType.CLOB, this, "");
